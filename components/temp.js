...
const ChatScreen = (props) => {
  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      await sendTextMessage(id, userData.userId, messageText, toneColor1, toneColor2, toneColor3, activeTone1, activeTone2, activeTone3, replyingTo && replyingTo.key);
  ...
  }, [messageText, chatId, toneColor1, toneColor2, toneColor3, activeTone1, activeTone2, activeTone3,]);
  ...
  const runNLP = e => {
    ...
    const newTimer = setTimeout (()=> {
      ...
      let explainInput = " Explain how the message was intended to be understood understood keep it to two sentence \n\nMessage:" + messageText + "\nTone:\n"
      let explainPayload = {
        model: "text-davinci-003",
        prompt: explainInput,
        temperature: 0,
